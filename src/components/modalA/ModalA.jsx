...
const ModalA = () => {
  ...
  useEffect(() => {
    const delay = setTimeout(() => {
      let params = `?companyId=560&page=${currentPage}&noGroupDuplicates=1`;
  ...
  }, [searchText, timeDelay, currentPage]);
  ...
  const loadMoreData = async () => {
    ...
    let params = `?companyId=560&page=${newPage}&noGroupDuplicates=1`;
